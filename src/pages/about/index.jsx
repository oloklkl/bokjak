...
const HomePage = () => {
    ...
    const questions = [
        ...
        },
        {
            ...
            answer: '언제 어디서나 시청할 수 있습니다. 로그인하면 PC에서 bokjak.com을 통해 바로 시청할 수 있으며, 인터넷이 연결되어 있고 넷플릭스 앱을 지원하는 디바이스(스마트 TV, 스마트폰, 태블릿, 스트리밍 미디어 플레이어, 게임 콘솔 등)에서도 언제든지 시청할 수 있습니다.',
        },
        {
            question: '복작을 얼마에 이용할 수 있나요?',
            answer: '스마트폰, 태블릿, 스마트 TV, 노트북, 스트리밍 디바이스 등 다양한 디바이스에서 월정액 요금 하나로 복작을 시청하세요. 멤버십 요금은 월 9,900원부터 15,600원까지 다양합니다. 추가 비용이나 약정이 없습니다.',
        },
    ];
    ...
    return (
        <AboutWrap>
            ...
            <section className="image-scroll scroll-1">
            ...
            <section className="image-scroll scroll-2">
                <div className="image-container">
                    {[
            ...
            <section className="image-scroll scroll-3">
                <div className="image-container">
                    {[
