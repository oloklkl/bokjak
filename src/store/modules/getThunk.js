...
export const getPeopleBySearch = createAsyncThunk('people/getPeopleBySearch', async ({ query }) => {
...
export const getContentById = createAsyncThunk('content/getContentById', async ({ type, id }) => {
    const res = await axios.get(`${BASE_URL}/${type}/${id}`, {
        params: {
            api_key: API_KEY,
            language: 'ko-KR',
